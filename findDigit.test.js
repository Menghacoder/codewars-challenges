...
describe.only("function toLeetSpeak that converts a regular english sentence to Leetspeak", ()=>{
    test("Basic tests", () =>{
        ...
        expect(toLeetSpeak("THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG")).toBe("7#3 QU!(K 8R0WN F0X JUMP$ 0V3R 7#3 1@2Y D06");
    })
})